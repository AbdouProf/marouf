                        ...
                        <ul class="utf-dashboard-box-list">
                                ...
                                <li>
                                            ...
                                            <div class="utf-manage-resume-avatar">
                                                ...
                                                <a href="#">
                                                    @php
                                                        ...
                                                        $new = \App\Models\offre::where('id', $item->id)->first();
                                                    @endphp
                                                    ...
                                                    <div class="utf-buttons-to-right">
                                                        <form class="float-left ml-1"
                                                            ...
                                                            <a href="#" class="dltBtn button red ripple-effect"
                                                                data-id="{{ $item->id }}" title="Supprime"
                                                ...
                                                @else
                                                    <div class="utf-buttons-to-right">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            title="Accept" data-tippy-placement="bottom" data-toggle="modal"
                                                            data-id="{{ $item->id }}"
                                    ...
                                    <div id="small-dialog-1" class="zoom-anim-dialog mfp-hide dialog-with-tabs"
                                        id="accepter{{ $item->id }}" role="popup">

                                        <div class="utf-signin-form-part">
                                            <ul class="utf-popup-tabs-nav-item">
                                                <li class="modal-title">Accepter l'offre de {{ $user->name }} </li>
                                            ...
                                            <div class="utf-popup-container-part-tabs">
                                                <div class="utf-popup-tab-content-item" id="tab">
                                                    <div class="utf-welcome-text-item">
                                                        <div class="bid-acceptance margin-top-15">L'offre :
                                                            {{ $new->Mnt_offre }} TND</div>
                                                    </div>
                                                    <form action="{{ route('offre.accept', $item->id) }}" id="accept-form"
                                                        method="POST">
                                                        ...
                                                        <div class="radio">
                                                            ...
                                                            <label for="radio-1"><span class="radio-label"></span> Avec
                                                                mon solde {{ $item->Mnt_offre }} </label>
                                                        </div>
                                                        <div class="radio">
                                                            <input id="radio-1" name="radio" type="radio" checked="">
                                                            <label for="radio-1"><span class="radio-label"></span> Carte
                                                                bancaire</label>
                                                        </div>
                                                        <div class="radio">
                                                            <input id="radio-1" name="radio" type="radio" checked="">
                                                        ...
                                                        <div class="checkbox margin-top-12">
                                                            ...
                                                            <label for="chekcbox1"><span class="checkbox-icon"></span> <a
                                                                    href="#">J'accepte les
                                                                    conditions générales et la politique de
                                                                    confidentialité</a></label>
                                                        </div>
                                                        <button
                                                            class="margin-top-15 button full-width utf-button-sliding-icon ripple-effect"
                                                            type="submit" form="accept-form">Accepter et payer <i
                            ...
                            <div class="modal fade" id="productID{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="false">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-content">
                                        <div class="utf-signin-form-part">
                                            <ul class="utf-popup-tabs-nav-item">
                                                <li style="color:white;font-size:20px;">Accepter l'offre de {{ $user->name }}
                                                </li>
                                            ...
                                            <div class="utf-popup-container-part-tabs">
                                                <div class="utf-popup-tab-content-item" id="tab">
                                                    <div class="utf-welcome-text-item">
                                                        <div class="bid-acceptance margin-top-15">L'offre :
                                                            {{ $item->Mnt_offre }} TND</div>
                                                    </div>
                                                 
                                                    <form action="{{ route('offre.accept', $item->id) }}" method="POST">                                                     
                                                        @csrf                   
                        
                                                        <div class="utf-section-headline-item  margin-bottom-12">
                                                            <h5>Méthode de paiement {{$item->id}}</h5>
                                                        </div>
                                                        <div class="radio">
                                                            <input id="radio-1" name="radio" type="radio" checked="">
                                                            <label for="radio-1"><span class="radio-label"></span> Avec
                                                        ...
                                                        <button class="margin-top-15 button full-width utf-button-sliding-icon ripple-effect"
                                                            type="submit" form="accept-form">Accepter et payer <i
                                                                class="icon-feather-chevrons-right"></i></button>
    ...
    @section('scripts')
        ...
        <script>
            ...
            $('.dltBtn').click(function(e) {
                ...
                swal({
                        title: "vous êtes sûr ?",
                        text: "Une fois supprimé, vous ne pourrez pas récupérer cette demande!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
                    .then((willDelete) => {
                        if (willDelete) {
                            $('#myForm').submit();;
                            swal(" Bien ! Votre demande a été supprimé!", {
                                icon: "success",
                            });
                        } else {
                            swal("Votre demande n'est pas supprimer!");
                        }
                    });
            });
        </script>
